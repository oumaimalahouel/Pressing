...
function ds_sh(t) {
	// Définissez l'élément à fixer ...
	ds_element = t;
	// Faire une nouvelle date, et régler le mois et l'année en cours.
	var ds_sh_date = new Date();
	ds_c_month = ds_sh_date.getMonth() + 1;
	ds_c_year = ds_sh_date.getFullYear();
	//Dessinez le calendrier
	ds_draw_calendar(ds_c_month, ds_c_year);
	// Pour changer la position correctement, nous devons montrer en premier.
	ds_ce.style.display = '';
	// Placez le récipient de calendrier!
